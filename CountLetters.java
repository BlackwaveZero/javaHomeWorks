...
public class CountLetters{
    public static void main(String[] args) {
        ...
        Strings toBeCounted=new Strings();
        str.readLine("Enter a text : ");
        toBeCounted.readLine("Enter a word that you want to get count of that in the text : ");
        System.out.println("numbers of ("+toBeCounted.get()+") found in the text is : "+str.count(toBeCounted.get()));
    }
}
class Strings{
    private String data="";
